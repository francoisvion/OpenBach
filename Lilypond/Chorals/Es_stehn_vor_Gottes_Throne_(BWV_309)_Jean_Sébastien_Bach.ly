    ...
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {S A} }
    {
      ...
      <<
        ...
        \new Voice = "alto" {
          ...
          d'8 [ees'] d'4 d'\fermata \bar "|."
        }
      >>
    }
    \new Lyrics \lyricsto "soprano" {
      Es steh'n vor Got -- tes Thro -- ne, es steh'n vor Got -- tes Thro -- ne die un -- sre Wäch -- ter sind, der in sein'm lie -- ben Soh -- ne, der in sein'm lie -- ben Soh -- ne liebt al -- le Men -- schen -- kind: als je -- mals ist ge -- born.
    }
