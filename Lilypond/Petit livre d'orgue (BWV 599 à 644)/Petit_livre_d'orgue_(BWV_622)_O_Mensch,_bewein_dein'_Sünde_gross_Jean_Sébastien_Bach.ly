...
%24
(do4) sib8. lab16 sol4\fermata \fine
...
<<
\new PianoStaff{
\set PianoStaff.instrumentName = \markup\column{\center-align\italic{"à 2 " "claviers "}}
<<
\new Staff
<<\soprano>>
\new Staff
<< \tenor \\ \alto >> >>}
 \new Staff{\set Staff.instrumentName = \markup\italic"pédalier"
\basse }>>
}
