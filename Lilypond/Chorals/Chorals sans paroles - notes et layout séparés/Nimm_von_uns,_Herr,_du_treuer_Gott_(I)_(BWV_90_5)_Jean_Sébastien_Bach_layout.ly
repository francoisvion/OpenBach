...
\include "Nimm_von_uns,_Herr,_du_treuer_Gott_(I)_(BWV_90_5)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Nimm von uns, Herr, du treuer Gott (I)" \small " (v. 7)"}}
