...
\include "BWV_1056R(ob)_header_w_hpd.ly"
...
scoreAViolinConcPart = \new Staff \with {
  instrumentName = "Oboe concertino"
  midiInstrument = "oboe"
...
scoreAHarpsichordPart = \new PianoStaff \with {
  ...
  \new Staff = "right" \with {
    ...
    \tiny
  } \keepWithTag #'ob_conc \scoreARight
  \new Staff = "left" \with {
...
scoreCViolinConcOssiaPart = \new Staff \with{
  ...
  \RemoveEmptyStaves
  \override VerticalAxisGroup.remove-first = ##t
} \keepWithTag #'ob_conc \scoreCViolinConcOssia
...
scoreCHarpsichordPart = \new PianoStaff \with {
  ...
  \new Staff = "right" \with {
    midiInstrument = "harpsichord"
    \tiny
  } \keepWithTag #'ob_conc \scoreCRight
  \new Staff = "left" \with {
    midiInstrument = "cello"
  } \keepWithTag #'ob_conc { \clef bass \scoreCBc }
>>
