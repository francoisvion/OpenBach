...
\include "Was_mein_Gott_will,_das_g'scheh_allzeit_(I)_(BWV_144_6)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Was mein Gott will, das g'scheh allzeit (I)" \small " (v. 1)"}}
