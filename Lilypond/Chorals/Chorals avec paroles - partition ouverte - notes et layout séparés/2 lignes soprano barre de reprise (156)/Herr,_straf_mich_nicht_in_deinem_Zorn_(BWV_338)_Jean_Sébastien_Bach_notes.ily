...
altoMusic = {
  \repeat volta 2 {
    ...
    a' gis' e'\fermata } g'
  fis' g' fis'4 fis'8 [e']
  e' [d'] d' [e'] e'4\fermata e'
  fis'16 [g'] a'4 gis'8 a'4. g'8
  g' [f'16 e'] d'4 e'\fermata e'
  e' e'4 e'8 [a'16 gis'] a'4	
...
tenorMusic = {
  \repeat volta 2 {
    ...
    f'8 [d'] b [e'16 d'] c'4\fermata } e'
  dis' e' b b8 [c']
  c' [d'16 c'] b [a b8] a4\fermata g
  b e' e' e'8. [d'16]
  c'4 b8 [a] b4\fermata b
  c' b a4. f'8
...
altoLyricsOne = \lyricmode {
      \set stanza = 1
   Herr, straf' mich nicht in dei -- nem _ Zorn, das bitt ich dich von Her - zen, und zücht -- ge mich nicht in dein'm Grimm, weil ich so _ voll Be -- trüb -- niss bin, und lei -- de gro -- ße Schmer - zen.
    }
