    ...
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {S A} }
    {
      ...
      <<
        ...
        \new Voice = "alto" {
          ...
          \partial 4 e'
          e' e'4. a'16 [gis'] a'4~
          a'8 [gis'16 fis'] gis'4 e'\fermata \bar "|."
        }
      >>
    }
    \new Lyrics \lyricsto "soprano" {
      Herr, straf' mich nicht in dei -- nem Zorn, das bitt ich dich von Her -- zen, sonst bin ich ganz und gar ver -- lorn, mit dir ist nicht zu Scher -- zen; auch züch -- tig mich nicht in deim Grimm,
    }
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {T B} }
    {
      ...
      <<
        \new Voice = "tenor" {
          ...
          f'8 [d'] b [e'16 d'] c'4\fermata \bar "|."
          \partial 4  e'
          dis' e' b b8 [c']~
