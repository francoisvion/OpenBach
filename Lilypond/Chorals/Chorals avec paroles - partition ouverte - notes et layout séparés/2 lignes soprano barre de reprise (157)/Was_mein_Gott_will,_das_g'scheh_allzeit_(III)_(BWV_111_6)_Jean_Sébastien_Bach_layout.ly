...
\include "Was_mein_Gott_will,_das_g'scheh_allzeit_(III)_(BWV_111_6)_Jean_Sébastien_Bach_notes.ily"
...
\header {
  title = \markup{\concat{"Was mein Gott will, das g'scheh allzeit (III)" \small " (v. 4)"}}
  subtitle = "tiré de la cantate : Was mein Gott will, das g'scheh allzeit"
  poet = \markup{\column{"Auteur : Markgraf Albrecht von" "Brandenburg (1490-1568)"}}
  opus = "BWV 111/6"
