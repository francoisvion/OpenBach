   ...
   \new Voice \relative a {
      ...
      a16 gis a h32 a <<
                         \new Voice { \override Staff.NoteCollision #'merge-differently-dotted = ##t
                                      \halsup gis16 e a8~ a[ gis!16 fis] gis4^\fermata \fine}
                         \new Voice { \halsdown s16 e8.~ e2_\fermata \fine}
                      >>
   }
}
...
pedal = {
   ...
   \relative e {
      ...
      e1~
      %% 25 
      \override Script #'padding = #0.8 e1_\fermata \fine
   }
}
