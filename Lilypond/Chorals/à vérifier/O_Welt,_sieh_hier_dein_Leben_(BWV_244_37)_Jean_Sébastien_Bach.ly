...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {\set stanza = 2
      In al -- len mei -- nen Ta -- ten lass ich den Höch -- sten ra -- ten, der al -- les kann und hat; er muss zu al -- len Ding -- en, soll's an -- ders wohl ge -- ling -- en, mir sel -- ber ge -- ben Rat und Tat.
    }
