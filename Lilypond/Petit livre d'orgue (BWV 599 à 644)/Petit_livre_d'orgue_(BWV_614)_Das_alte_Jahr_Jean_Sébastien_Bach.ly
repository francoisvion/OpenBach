...
choral = \relative do'' {
  ...
  \partial 2. la16 ^( sold!16 ) do16 ^( si16 ) mi16 red16 fad16 la,16 la8 ([ \once\override Voice.TextScript #'extra-offset = #'(1.1 . 0.2) sold!8^\markup{\musicglyph #"scripts.trill"} ] \bar "|.")
}
