...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {
      Je -- su, der du sel -- bsten wohl hast den Tod ge -- schme -- cket, hilf mir, wenn ich ster -- ben soll, wenn der Tod mich schre -- cket: Wenn mich mein Ge -- wis -- sen nagt und die Sün -- den pla -- gen, wenn der Sa -- tan mich ver -- klagt, lass mich nicht ver -- sa -- gen.
    }
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {T B} }
    {
      ...
      <<
        \new Voice = "tenor" {
          ...
          d'4 e' d'8 [b cis' e']
          fis' [d'] b [e'16 d'] cis'2\fermata \bar "|."
        }
        \new Voice = "bass" {
          \voiceTwo
           a,4 cis d e
