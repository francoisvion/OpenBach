...
global = {
   ...
   % Configuration moderne des ligatures automatiques (remplace les fonctions obsolètes)
   \set Timing.beatBase = #(ly:make-moment 1/4)
...
alt = {
   \new Voice \relative gis {
      \global
      \staffdown
      \partial 4 r16 gis32 a h16 a32 h
      \repeat volta 2 {
      ...
      \alternative {
         {
            e16 cis32 d e16 f32 e d16 h32 cis d16 e32 d cis!16 \staffdown a32 h c!16 h32 a 
            r16 gis32 a h16 a32 h
         }
         {
      ...
      e4 r16 e32 f g16 f32 g a16 g32 a h16 a32 h c16 c,32 d e16 d32 e
...
tenor = {
   \new Voice \relative e {
      \global
      \partial 4 r16 e32 fis gis!16 fis32 gis
      \repeat volta 2 {
      ...
      \alternative {
         {
            cis16 e32 f g!16 a32 g f16 d32 e f16 g32 f e4 r16 e32 fis gis!16 fis32 gis
         }
         {
