...
% --- Macros ---
staffdown = {\change Staff = "basse" \stemUp \tieUp \slurUp}
staffup = {\change Staff = "dessus" \stemDown \tieDown \slurDown}
...
soprano = \relative do'{
  ...
  \partial 8 do8
  \repeat volta 2 {
     fa8. sol32 lab32 sol8. fa32 sol32 lab4 sib8 lab8 
     sol16 [la32 si32 do16 re32 mib32] fa16 re16 sol,16 fa'16 mib4 r16 fa32 [sol32 lab16 sib32 do32] 
     ...
     r16 la,32 [si32 do16 re32 mib32] fa16 re16 si16 re16~ re8 reb8 do4~
     do16 [fa,32 sol!32 lab16 sib32 do32] reb4~ reb16 [sib32 lab32 sol16 lab32 sib32] mi,16 sol16 do,16 mi16 
     fa8 re'8 r16 do32 [re32 mi16 fa32 sol32] lab8 [sol8]~ sol8. fa16~
     fa16 [mi32 re32 mi16 sol16]~ sol16 [do,32 reb32 mib16 fa32 solb32] solb16 fa16 fa16 mib16 mib16 [reb!16 reb8]~
     reb16 [sol,32 lab32 sib16 do32 reb32]~ reb16 sib16 sol16 do16 lab8 r8 r16 sib16 fa16 lab16 
 }
  \alternative {
    { sol8 r8 r16 fa16 si,16 re16 mi!4 r16 do8.}
    { sol'8 r8 r16 fa16 si,16 re16 mi!4 r16 sol32 [lab32 sib16 do32 reb32]}
 }
 ...
 fa16 [sib,32 do32 re16 mib32 fa32] sol16 mib16 sib16 re16 mib8 r8 r4 
 r16 fa,32 [sol32 lab16 sib32 do32] reb16 sib16 sol16 do16 lab4 r4 
 r16 si!32 [do32 re16 mib32 fa32] sol4~ sol8. mib16 fa8. re16 
...
alto = \relative do' {
  ...
  \partial 8 r8 
  \repeat volta 2 {
      r2 r16 lab32 [sib32 do16 re!32 mib32] fa16 \staffdown sib,16 fa16 \staffup re'16~
      re8 \staffdown do4 si8 do4 r4 \staffup
      r2 r16 re!32 [mi!32 fa16 sol32 lab32] sib16 sol16 do,16 sib'16 
      lab8 sol8 fa8 sol8~ sol8 fa4 mi8 
      fa16 [\staffdown fa,32 sol32 lab16 sib32 do32] \staffup reb16 sib16 sol16 do16 fa,4 r16 sib32 [do32 re!16 mib!32 fa32] 
      sol2~ sol16 [mib32 fa32 sol16 lab!32 sib!32] do16 lab16 mib16 solb16 
     fa16 r8. r16 sib'16 fa16 lab16 sol!8 r8 r4 
      r16 do,32 [re32 mi!16 fa32 sol32] lab8 r8 r16 do8 [sib16]~ sib16 lab32 sol32 lab8 
     sol4 lab8 r8 do4~ do8 [sib16 lab!16]   
     sib8 r8 r4 r16 fa'32 [sol32 lab16 sib32 do32] reb,8 r8 
 } 
  \alternative {
    {r16 do32 [re!32 mi16 fa32 sol32] lab,8 r8 r16 sol32 [lab32 sib!16 do32 reb32] \staffdown mi,!16 \staffup do'16 \staffdown sol16 sib16 \staffup}
    {r16 do32 [re!32 mi16 fa32 sol32] lab,8 r8 r16 sol32 [lab32 sib!16 do32 reb32] \staffdown mi,!16 \staffup do'16 \staffdown sol16 sib16 \staffup}
 } 
 ...
 do8 r8 \staffdown r4 r8 lab16 [sib32 do32] reb4~
 reb16 [do32 sib32 do16 reb!32 mib32] fa16 reb16 sib16 sol'16 lab8 r8 r4 
 \staffup R1 
 R1 
 ...
 si,!8 r8 r16 mib'16 si!16 re16 sol,8 [do8]~ do8 sib!8~ 
 sib8 [\staffdown  do,!8]~ do8 [fa8] reb!8 r8 \staffup r16 sol16 do,8~ 
 do8 [mib8]~ mib8 [reb8] do16 [fa8.]~ fa16 sib8.~ 
  ...
  << 
    ...
    {r8 reb!4 reb4 reb4 \tieUp  reb8~ reb8 \tieNeutral reb!4 reb4 reb4. do1}
  >>
}
...
tenor = \relative do  {
  ...
  \partial 8 r8
  \repeat volta 2 {
     r16 fa32 [sol32 lab16 sib32 do32] reb16 sib16 mi,16 do'16 fa,8 mib8 re!8 sib8 
     mib4 re4 r16 do32 [re32 mib16 fa32 sol32] lab4~
  ...
  \alternative {
    {mi,!8 [do8] fa8 fa'8 do4 r4}
    {mi!8 [do8] fa8 fa'8 do4 r4}
 }
 r4 r16 reb'!32 [mib32 fa16 sol!32 lab32] sol8 lab8 fa8 re!8 
 \halsdown mi!8 [fa8] reb8 [sib8]~ sib8 lab16 fa16 do'4
 fa,8 r8 r4 r16 reb'!32 [mib32 fa16 sol32 lab32] sib,8 mib8 
 lab,8 solb'!8 fa8 reb!8 lab8 r8 r4 
 r2 r16 lab'32 [sib32 do16 re!32 mib32] fa4~
 ...
 << 
    {fa8 fa,8 r8 \stemDown fa8 \stemUp fa8 [fa,8] r8 \stemDown fa'8~ fa1^\fermata} 
    \\
    {s1 fa,1}
 >>
}
...
\score {
  \unfoldRepeats {
    <<
      \new Staff { \set Staff.midiInstrument = "pan flute" \sopranomidi }
      \new Staff { \set Staff.midiInstrument = "pan flute" \altomidi }
      \new Staff { \set Staff.midiInstrument = "pan flute" \tenormidi }
      \new Staff { \set Staff.midiInstrument = "bassoon" \choralmidi }
    >>
  }
  \midi { \tempo 4 = 60 }
}