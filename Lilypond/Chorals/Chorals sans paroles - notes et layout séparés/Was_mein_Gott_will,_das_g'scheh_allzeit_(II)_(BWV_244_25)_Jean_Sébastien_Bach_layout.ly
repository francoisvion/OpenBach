...
\include "Was_mein_Gott_will,_das_g'scheh_allzeit_(II)_(BWV_244_25)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Was mein Gott will, das g'scheh allzeit (II)" \small " (v. 1)"}}
