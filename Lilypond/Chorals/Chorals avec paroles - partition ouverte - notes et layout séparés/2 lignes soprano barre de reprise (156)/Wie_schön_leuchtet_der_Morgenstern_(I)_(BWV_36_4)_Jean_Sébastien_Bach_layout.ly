...
\include "Wie_schön_leuchtet_der_Morgenstern_(I)_(BWV_36_4)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Wie schön leuchtet der Morgenstern (I)" \small " (v. 6)"}}
