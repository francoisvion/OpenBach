...
\paper {
  ...
  indent = 18\mm        % Assez large pour des noms comme "Violino" et "Pianoforte"
  short-indent = 8\mm
...
\book {
  \score {
    <<
      \new PianoStaff {
        \set PianoStaff.instrumentName = \markup { \large "Claviers " }
        <<
      ...
      \context Staff = unten {
        \set Staff.instrumentName = \markup { \large "Pédalier " }
