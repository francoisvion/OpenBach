...
\score {\new PianoStaff
	...
	\context Staff = "RH" { % Right hand 
		...
		\set tempoWholesPerMinute = #60/4
		\newSpacingSection
		\override Score.SpacingSpanner #'common-shortest-duration = \musicLength 16
		\mark \default 
		\Arh 
		\set tempoWholesPerMinute = #45/2  
		\newSpacingSection 
		\override Score.SpacingSpanner #'common-shortest-duration = \musicLength 4
		\mark \default 
		\Brh
		\set tempoWholesPerMinute = #95/4  
		%\newSpacingSection %it is inside Brh
		\override Score.SpacingSpanner #'common-shortest-duration = \musicLength 16
		\mark \default 
		\Crh\break
		\set tempoWholesPerMinute = #45/4  
		\newSpacingSection 
		\override Score.SpacingSpanner #'common-shortest-duration = \musicLength 8
		\mark \default 
		\Drh
		\set tempoWholesPerMinute = #180/8 
		\newSpacingSection 
		\override Score.SpacingSpanner #'common-shortest-duration = \musicLength 16
		\mark \default 
		\Erh
