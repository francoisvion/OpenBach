...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {
      Ich dank' dir, lie -- ber Her -- re, dass du mich hast be -- wahrt
      in dies'r Nacht G'fähr -- de, drin ich lag so hart
      mit Fins -- ter -- nis um -- fan -- gen, da -- zu in groß'r Not,
      draus ich bin ent -- gan -- gen, halfst du mir, Her -- re Gott.
    }
