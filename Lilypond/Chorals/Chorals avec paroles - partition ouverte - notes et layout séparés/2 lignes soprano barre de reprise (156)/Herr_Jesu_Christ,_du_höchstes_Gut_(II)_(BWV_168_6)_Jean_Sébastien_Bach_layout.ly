...
\include "Herr_Jesu_Christ,_du_höchstes_Gut_(II)_(BWV_168_6)_Jean_Sébastien_Bach_notes.ily"
...
\header {
 title = \markup{\concat{"Herr Jesu Christ, du höchstes Gut (II)" \small " (v. 8)"}}
