...
melone =  \relative c'' {
  % bars 1-4
  r16 g a b \stemDown c d e f g f g a f a g f |
  e2 ~ \stemUp e4 fis | \break
  g8 f! e4 d8 e16 f d4 ~ |
...
meltwo =  \relative c' {
  ...
  fis8 \hide r \hide r4 d'16\rest d e f! e4 ~ |
  e16 \hide r \hide r8 \hide r4 a,8\rest a b cis |
  ...
  f4 ~ | f 
  c16\rest f e d c d c bes a4 ~ |

  % bars 19-21
   a8 d4 c8 ~ c b16 a b c d b |
...
melthree =  \relative c {
  ...
  c4 r8 c' b g a b |
  c4 r8 b a g a d, |
  g,16 g' a b \clef G c d e f g f g a f a g f |
  e f e d \clef F c b a g f g f e f d e f |
  ...
  a g a b! \clef G c d e f g f g a f a g f |
  e4 r r16 c' b a g f e d \clef F |
