    ...
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {S A} }
    {
      ...
      <<
        ...
        \new Voice = "alto" {
          ...
          e'1
          cis'8 [d'] e'4. d'8 e'4~
          e'8 [cis'16 b] cis'4 a2\fermata \bar "|."
        }
      >>
    }
    \new Lyrics \lyricsto "soprano" {
      O wir ar -- men Sün -- der! uns -- re Mis -- se -- that, da -- rin wir em -- pfan -- gen und ge -- bo -- ren sind, hat ge -- bracht uns al -- le in sol che gro -- sse Noth, dass wir un -- ter -- wor -- fen sind dem ew' -- gen Tod. Ky -- rie e -- lei -- son! Chri -- ste e -- lei -- son! Ky -- ri -- e e -- lei son! Ky -- rie e -- leis'!
    }
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {T B} }
    {
      ...
      <<
        \new Voice = "tenor" {
          ...
          d'4 d' cis' b
          a2~ a16 [b] c'4 b16 [a]
          b8 e4 fis16 [g] fis2\fermata \bar "|."
        }
        \new Voice = "bass" {
          \voiceTwo
           d4. cis8 d [e fis d]
