...
\include "Der_Herr_ist_mein_getreuer_Hirt_(II)_(BWV_112_5)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
 title = \markup{\concat{"Der Herr ist mein getreuer Hirt (II)" \small " (v. 5)"}}
