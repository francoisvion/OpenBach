...
\include "Herr,_wie_du_willst,_so_schicks_mit_mir_(BWV_156_6)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
 title = \markup{\concat{"Herr, wie du willst, so schicks mit mir" \small " (v. 1)"}}
