    ...
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {S A} }
    {
      ...
      <<
        \new Voice = "soprano" {
          ...
          cis''4 dis'' e'' d''
          cis''8 [d''16 e''] cis''4 b'\fermata \bar "|."
        }
        \new Voice = "alto" {
          \voiceTwo
          \partial 4  dis'4
          ...
          a'4 a' b'8 cis''4 b'8
          b' [ais'16 gis'] ais'4 fis'\fermata \bar "|."
        }
      >>
    }
    \new Lyrics \lyricsto "soprano" {
      O Je -- su, du mein Bräu -- ti -- gam, der du aus Lieb' am Kreu -- zes -- stamm für mich den Tod ge -- lit -- ten hast, ge -- nom -- men weg der Sün -- den Last.
    }
