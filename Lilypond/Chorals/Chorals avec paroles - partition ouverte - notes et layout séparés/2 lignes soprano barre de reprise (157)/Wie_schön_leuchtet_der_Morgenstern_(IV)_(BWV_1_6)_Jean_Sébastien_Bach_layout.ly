...
\include "Wie_schön_leuchtet_der_Morgenstern_(IV)_(BWV_1_6)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Wie schön leuchtet der Morgenstern (IV)" \small " (v. 7)"}}
  subtitle = "tiré de la cantate : Wie schön leuchtet der Morgenstern"
