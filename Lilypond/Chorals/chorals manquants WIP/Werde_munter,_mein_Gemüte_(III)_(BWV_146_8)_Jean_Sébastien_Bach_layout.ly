...
\include "Werde_munter,_mein_Gemüte_(III)_(BWV_146_8)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Werde munter, mein Gemüte (III)" \small " (Freu dich sehr)"}}
  subtitle = "tiré de la cantate : Wir müssen durch viel Trübsal in das Reich Gottes eingehen"
