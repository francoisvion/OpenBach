upperFive = \relative c''
{
  ...
  \repeat volta 2
  {
	...
	<< { bf8  a  bf g a g' } \\
	   { \change Staff = "lowerFive" cs,,4   cs   cs \change Staff = "upperFive"   } \\
	   { \stemDown e4      e    e    \stemUp } >>                  	     | % 21

	<< { f'16 d   cs d    bf'4          a         } \\
	   { d,,8 \change Staff = "lowerFive" d, \change Staff = "upperFive" r16 d'' c bf  r c bf! a } \\
	   { s4               f'            e         } >>   | % 22
	...
	<<            {           f'2. ~               }
	   \new Voice { \voiceTwo r8 d a f d  r } >>  | % 26

	f'16 b, a b  c b a b  d b a b                        | % 27

	<<            {           e2. ~                } 
	   \new Voice { \voiceTwo r8 c g e c r } >>  | % 28
