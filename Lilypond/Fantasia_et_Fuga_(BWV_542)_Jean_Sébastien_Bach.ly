...
\paper {
   left-margin = 0.7 \cm
   right-margin = 0.7 \cm
   obsolete-page-top-space = 0 \cm  top-system-spacing.basic-distance = #(/ obsolete-page-top-space staff-space)
   obsolete-before-title-space = 0 \cm  score-markup-spacing.basic-distance = #(/ obsolete-before-title-space staff-space)
   obsolete-after-title-space = 0 \cm  markup-system-spacing.basic-distance = #(/ obsolete-after-title-space staff-space)
   ragged-bottom = ##f
