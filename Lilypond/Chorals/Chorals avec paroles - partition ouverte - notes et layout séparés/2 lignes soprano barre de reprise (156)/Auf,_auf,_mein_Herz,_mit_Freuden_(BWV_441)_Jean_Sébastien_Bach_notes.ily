...
sopranoLyricsOne = \lyricmode {\set stanza = 1
   Auf, auf, __ _ mein Herz, mit Freu -- den,
...
sopranoLyricsTwo = \lyricmode {\set stanza = 2
   wie kommt __ _ nach gro -- ßen Lei -- den
