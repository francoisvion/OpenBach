...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {
      Von Gott will ich nicht laß -- sen, denn er läßt nicht von mir,
      führt mich auf rech -- ter Stra -- ßen, da ich sonst irrt' sehr.
      Er reicht mir sein' Hand, den A -- bend und Mor -- gen
      tut er mich ver -- sor -- gen.
    }
