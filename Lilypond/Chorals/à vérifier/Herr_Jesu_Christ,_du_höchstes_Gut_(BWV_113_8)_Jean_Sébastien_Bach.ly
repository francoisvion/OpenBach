...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {\set stanza = 1
      Stärk mich mit dei -- nem Freu -- den -- geist, heil mich mit dei -- nen Wun -- den; und nimm mich einst, wenn dirs ge -- fällt, in wah -- ren Glau -- ben von der Welt zu dei -- nen Aus -- ser -- wähl -- ten! _ _
    }
    \new Lyrics \lyricsto "soprano" {\set stanza = 2
      wasch mich mit dei -- nem To -- des -- schweiss in mei -- ner letz -- ten Stun -- den; und nimm mich einst, wenn dirs ge -- fällt, in wah -- ren Glau -- ben von der Welt zu dei -- nen Aus -- ser -- wähl -- ten! _ _
    }
