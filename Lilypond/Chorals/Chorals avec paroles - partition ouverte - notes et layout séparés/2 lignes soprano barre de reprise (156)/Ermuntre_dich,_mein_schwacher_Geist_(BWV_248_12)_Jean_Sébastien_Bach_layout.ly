...
\include "Ermuntre_dich,_mein_schwacher_Geist_(BWV_248_12)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
 title = \markup{\concat{"Ermuntre dich, mein schwacher Geist" \small " (v. 9)"}}
