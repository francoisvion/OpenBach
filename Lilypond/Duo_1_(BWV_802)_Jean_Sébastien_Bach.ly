...
staffHarpsichord = \new PianoStaff {
	...
	\set PianoStaff.instrumentName = #""
		...
		\context Staff = "RH" {
			\clef treble
			\key e \minor
			\relative c' {e32 fs g a b cs ds e ds cs b a|
				...
				e8 r8 e,~|
				e32 [cs ds g] g [e fs e'] ds [cs ds a]|
				g fs e16 r8 r8 |
				...
				cs [e f16~] f32 [d gs,16~] gs32 [g e' g,]|
				...
				e, fs gs |
				a b cs |
				d32 c! b a gs fs! e ds e fs gs a|
				b c d16 r8 r32 d32 c b|
				a b c d e fs g a g fs e ds |
				c'a b16 r8 r32 a,32 g fs|
				e fs g a b cs ds e ds cs b a|
		...
		\context Staff = "LH" {
			...
			\relative c {r4.|
				...
				cs [e f16~] f32 [d gs,16~] gs32 a e' g|
				...
				cs c,! c'|
				b cs ds |
				e,32 fs g a b cs ds e ds cs b a |
				g fs e16 r16 c'16 b as|
				as32 b b,16 r16 bf' a gs|
				gs32 a a,16 r32 a c e a g fs e|
				ds [fs g16~] g32 [e as,16~] as32 a fs' a,|
