...
sopran = {
  \new Voice \relative b'' {
    ...
    << 
      { \voiceOne  h16 [e32 dis e8]^\fermata }
      \new Voice { \voiceTwo h4 } 
    >> \oneVoice
  }
}
...
pedal = {
  ...
  \relative d, {
    ...
    <<
      { \voiceOne r8 d8. \set stemLeftBeamCount = #1 \set stemRightBeamCount = #2 e16 \set stemLeftBeamCount = #2 fis gis a2 s4 e,2. \fermata }
      \new Voice { \voiceTwo gis,4 e r8 a8. \set stemLeftBeamCount = #1 \set stemRightBeamCount = #2 h16 \set stemLeftBeamCount = #2 c d e1 }
    >> \bar "|."
  }
}
