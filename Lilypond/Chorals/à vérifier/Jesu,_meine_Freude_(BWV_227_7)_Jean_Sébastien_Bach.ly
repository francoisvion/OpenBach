...
\score {
  \new ChoirStaff <<
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {S A} }
    {
      ...
      <<
        ...
        \new Voice = "alto" {
          ...
          e' [dis'16 cis'] dis'4 e'8 [dis'] e' [fis']
          g'16 [fis' g'8] r e' a'4. g'16 [fis']
          g'8 [a'16 b'] a'4 b' r8 c''
          b' [a'] g' [b'] c'' [a'] fis'4
    ...
    \new Lyrics \lyricsto "soprano" {\set stanza = 1
      Weg mit al -- len Schä -- tzen, du bist mein Er -- gö -- tzen, Je -- su, mei -- ne Lust! E -- lend, Not, Kreuz, Schmach und Tod soll mich, ob ich viel muss lei -- den, nicht von Je -- su schei -- den.
    }
    \new Lyrics \lyricsto "soprano" {\set stanza = 2
      Weg mit ihr eit -- len Eh -- ren, ich mag euch nicht hö -- ren, mir un -- be -- wusst! E -- lend, Not, Kreuz, Schmach und Tod soll mich, ob ich viel muss lei -- den, nicht von Je -- su schei -- den.
    }
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {T B} }
    {
      ...
      <<
        \new Voice = "tenor" {
          ...
          dis'4 r8 b e' [e'16 dis'] e'4~
          e'8 dis' e' [g] c' [a] fis [b]
          b [gis] fis [a] gis2 \fine
        }
        \new Voice = "bass" {
          \voiceTwo
          \repeat volta 2 {
