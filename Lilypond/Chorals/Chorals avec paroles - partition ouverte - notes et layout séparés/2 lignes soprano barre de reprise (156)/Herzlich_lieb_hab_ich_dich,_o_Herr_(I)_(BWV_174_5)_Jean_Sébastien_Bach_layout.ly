...
\include "Herzlich_lieb_hab_ich_dich,_o_Herr_(I)_(BWV_174_5)_Jean_Sébastien_Bach_notes.ily"
...
\header {
 title = \markup{\concat{"Herzlich lieb hab ich dich, o Herr (I)" \small " (v. 1)"}}
