...
\markup {
  ...
  \column \small\italic {
     ...
     \line {
       \concat {
         " " \hspace #.3 \vspace #1
         "Ô Dieu, et je t'en supplie humblement,"
       }
     }
     \line {
       \concat {
         " " \hspace #.3
         "Ne détourne pas ton visage miséricordieux,"
     ...
     \line {
       \concat {
         " " \hspace #.3
         "Accorde-moi une fin bien heureuse,"
       }
     }
     \line {
       \concat {
         " " \hspace #.3
         "Au dernier jour, réveille-moi, Seigneur,"
         " afin que je puisse te voir éternellement."
       }
     }
     \line {
       \concat {
