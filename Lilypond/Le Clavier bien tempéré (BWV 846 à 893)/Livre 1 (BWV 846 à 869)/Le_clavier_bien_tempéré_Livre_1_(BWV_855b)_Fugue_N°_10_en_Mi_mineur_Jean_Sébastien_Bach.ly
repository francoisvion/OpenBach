...
\header {
  title = "Fugue N° 10"
  subtitle = "Le clavier bien temptéré - Livre 1"
...
\paper { obsolete-between-system-padding = 2\mm  system-system-spacing.padding = #(/ obsolete-between-system-padding staff-space)  score-system-spacing.padding = #(/ obsolete-between-system-padding staff-space) obsolete-between-system-space = 2\mm  system-system-spacing.basic-distance = #(/ obsolete-between-system-space staff-space)  score-system-spacing.basic-distance = #(/ obsolete-between-system-space staff-space) ragged-last-bottom = ##f obsolete-after-title-space = 1\mm  markup-system-spacing.basic-distance = #(/ obsolete-after-title-space staff-space) obsolete-between-title-space = 0.2\mm  markup-markup-spacing.basic-distance = #(/ obsolete-between-title-space staff-space) indent = 0\mm print-page-number = ##t
