...
\header
{
  title = "Chorale prélude : Wer nur den lieben Gott läßt walten"
...
upper = \relative c'
{
  ...
  {
    \partial 4 e4	                                       	      	      |
    a16\mordent b a b b8.\downprall a32 b c4 b16( c32 d c16 b) 	      	      |
    ...
    \unHideNotes
    e8\noBeam\fermata g       |
    g16 f e f f8. e16 e4\mordent r16 a b c\mordent                    	      |
    c16 b c\mordent d
    ...
    \appoggiatura a16
    \unHideNotes
    gs8. a16 a4\mordent s4
  }
  \partial 4  b8\mordent ~ b32 c64 b a32 b                            	      |
  c16 d c d d8.\downprall c32 d e4 e16f32 g f16 e\prall               	      |
  a16 b, c d g, f' e d32 c c4\mordent\fermata e16( g f e              	      |
