...
sopran = \relative f' {
  ...
  e8 d4 c8~ c16 a h d f8 h,
  c4 d4 e16 c a c f, e' d c
  h16 c a h c a g f e8 c'4 h!16 a
  g16 a f g a g f e d e f4 e16 d
  e16 c e g c f, a c d b! g b e, d' c b
  a8 d8\rest d2 e4
  f8 f\rest f4\rest f8\rest g4 f8
...
alt = \relative c' {
  ...
  f8 e h\rest << { \shiftOn \stemUp e8 e d16 cis! } \\ { \shiftOnn \stemUp cis8 \stemDown cis[ d] } >> d8. c16
  b16 c a b c b a g d'2
  c2 b2
...
altzwo = \relative d' {
  ...
  g16 a f g a g fis e fis d e fis g f e d
  g4 a4 g2
...
tenor = \relative f {
  ...
  g8 f16 e \halsneutral f8 a~ a g16 f g8 b~
  b8 a4 g16 f e f d e f e d c
  g'8 f16 g a4~ a8 g16 fis g4~
