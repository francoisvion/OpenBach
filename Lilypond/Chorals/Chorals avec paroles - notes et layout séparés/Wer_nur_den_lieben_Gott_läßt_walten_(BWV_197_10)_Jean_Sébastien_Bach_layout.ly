...
\include "Wer_nur_den_lieben_Gott_läßt_walten_(BWV_197_10)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
 title = \markup{\concat{"Wer nur den lieben Gott läßt walten" \small " (v. 7)"}}
