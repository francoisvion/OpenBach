    ...
    \new Staff \with { \autoBeamOff instrumentName = \markup \center-column {S A} }
    {
      ...
      <<
        ...
        \new Voice = "alto" {
          ...
          e'2. d'4~
          d' cis'8 [b] cis'4\fermata \bar "|."
        }
      >>
    }
    \new Lyrics \lyricsto "soprano" {
      Es woll' uns Gott ge -- nä -- dig sein und sei -- nen Se -- gen ge -- ben; dass wir er -- ken -- nen sei -- ne Werk; und, was ihn liebt, auf Er -- den, und Je -- sus Chris -- tus Heil und Stärk be -- kannt den Hei -- den wer -- den und sie zu Gott be -- keh -- ren, und sie zu Gott be -- keh -- ren.
    }
