...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {\set stanza = 2
      Auf mei -- nen lie -- ben Gott trau ich in Angst und Noth. Der kann mich all -- zeit ret -- ten aus Trüb -- sal, Angst und Nö -- then; mein Un -- glück kann er wen -- den: steht All's in sei -- nen Hän -- den.
    }
