...
sopran = {
  \new Voice \relative h' {
    ...
    e2. d~
    d8 h g h d g e2.
    a,16\rest d, e f e8( d) d( cis) f16\rest cis d e d8( c) c( h!)
    ...
    d4 s2 r16 \clef bass f, g a g a g f f g f e \clef treble
    e8 h'\rest h4\rest d\rest d16\rest \stemDown d e f e8(d) d(cis)
    r16 cis d e d8 (c) c (h) h2.~
    ...
    d16 c! h! a h d f e d c h a g a g f g h c d e g, f e
    ...
    c16\rest es, d c 
    << \new Voice { \voiceOne d8([ fis) fis( g)] g2.^\fermata \fine}
       \new Voice { \voiceTwo s8 es![ es d] d2. \fine}
    >>
  }
}
...
alt = {
  \new Voice \relative h {
    ...
    h16 e, f g f g f e e f e d d4 s2
    \stemUp g'8 e c e g c h2 b8 a
    b4 e,\rest a~ a16 fis g a g8( f) f( e)
...
leftVar = { % Renommé pour éviter conflit
  \clef "alto"
  <<
    \tenor
    \bass
...
\score {
  \unfoldRepeats {
    <<
      \new Staff { \set Staff.midiInstrument = "church organ" \right }
      \new Staff { \set Staff.midiInstrument = "church organ" \leftVar }
