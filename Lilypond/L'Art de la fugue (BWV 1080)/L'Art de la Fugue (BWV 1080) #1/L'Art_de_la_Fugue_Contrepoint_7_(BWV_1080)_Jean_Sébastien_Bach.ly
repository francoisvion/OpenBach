...
soprano = \relative c'''{
	...
	r16 d' c bes a4~ a16[ bes a g] f8 g16 a
...
alto = \relative c''{
	...
	f r r d~ d r r4
	r r8 gis, a2
	bes4~ bes16 c bes a g fis e a fis4
	g2 a\fermata
}
tenor = \relative c'{
