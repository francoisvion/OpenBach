...
sopran = {
   \new Voice \relative g' {
      \global
      \halsup
      % Application moderne du positionnement des ornements hors des liaisons
      \override Script.avoid-slur = #'outside
      
      % Correction de \compressMusic par \scaleDurations
      g4~ g32 a h a g16 a32 fis \appoggiatura fis16 \scaleDurations #'( 5 . 6 )
      ...
      \appoggiatura a16 h16. \mordent c32 d e fis g h,16( a) a\prall g32 a
         g2\mordent \bar "|."
   }
}
