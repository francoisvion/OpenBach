...
\include "Herr_Jesu_Christ,_du_höchstes_Gut_(III)_(BWV_113_1)_Jean_Sébastien_Bach_notes.ily"
...
\header {
  title = \markup{\concat{"Herr Jesu Christ, du höchstes Gut (III)" \small " (v. 1)"}}
