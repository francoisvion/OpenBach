...
\include "Wer_nur_den_lieben_Gott_läßt_walten_(I)_(BWV_88_7)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Wer nur den lieben Gott läßt walten (I)" \small " (v. 8)"}}
