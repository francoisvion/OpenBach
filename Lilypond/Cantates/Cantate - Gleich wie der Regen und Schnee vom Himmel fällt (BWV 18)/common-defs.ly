...
% By Harm (Thomas Morley)
% http://lists.gnu.org/archive/html/lilypond-user/2014-03/msg00817.html
...
% Figured Bass extender line that is just part of the figure column
...
%
% Johan Vromans
% http://lists.gnu.org/archive/html/lilypond-user/2015-01/msg00372.html
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% \ifDefined symbol
%%
...
% Thanks to: Dan Eble <address@hidden>
% Usage:
%
