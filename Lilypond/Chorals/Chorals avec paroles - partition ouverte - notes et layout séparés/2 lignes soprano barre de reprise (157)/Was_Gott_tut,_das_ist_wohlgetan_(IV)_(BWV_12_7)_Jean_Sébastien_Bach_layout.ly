...
\include "Was_Gott_tut,_das_ist_wohlgetan_(IV)_(BWV_12_7)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Was Gott tut, das ist wohlgetan (IV)" \small " (v. 6)"}}
  subtitle = "tiré de la cantate : Weinen, Klagen, Sorgen, Zagen"
