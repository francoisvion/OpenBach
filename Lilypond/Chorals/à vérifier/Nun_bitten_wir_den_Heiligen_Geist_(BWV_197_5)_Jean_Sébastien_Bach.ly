...
\score {
  \new ChoirStaff <<
    ...
    \new Lyrics \lyricsto "soprano" {\set stanza = 2
      Nun bit -- ten wir den hei -- li -- gen Geist um den rech -- ten Glau -- ben al -- ler -- meist, dass er uns be -- hü -- te an un -- serm En -- de, wenn wir heim -- fahr'n aus die -- sem E -- len -- de. Ky -- ri -- e e -- leis'.
    }
