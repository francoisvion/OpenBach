...
g8 e
    ...
    ais' b fis~ fis16 e d g! 
e8 cis dis16 e fis8~ fis16 e b d cis d e8~
e16 d a c!
    \change Staff = "lower" \stemUp
    b g b
     \change Staff = "upper" \stemDown
     d g a bes8~ bes16 g e a 
f8
     \change Staff = "lower" \stemUp
    d b!
     \change Staff = "upper" \stemDown
...
f d e cis a cis d8 e16 d cis! b a4^~
  %70
\once\stemUp a  {  g16 } f e d
    cis b cis  {  e } a,8 a\rest
...
g16 g f e f e f d
     \change Staff = "lower" \stemUp\tieUp b d c b a4~
a r r2
R1
  %65
...
\score {
  ...
  >>
  \header {
    piece = \markup { \larger "2. Fugue (double fugue)" }
  }
