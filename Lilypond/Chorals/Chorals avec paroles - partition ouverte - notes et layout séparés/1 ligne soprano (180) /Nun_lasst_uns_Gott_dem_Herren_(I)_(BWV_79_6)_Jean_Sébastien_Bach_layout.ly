...
\include "Nun_lasst_uns_Gott_dem_Herren_(I)_(BWV_79_6)_Jean_Sébastien_Bach_notes.ily"
\paper {
  #(set-paper-size "a4")
...
\header {
  title = \markup{\concat{"Nun lasst uns Gott dem Herren" \small " (v. 8)"}}
  subtitle = "tiré de la cantate : Gott der Herr ist Sonn und Schild"
