...
soprano = {
	...
	\relative c'' {
		...
		fis e16 dis e fis g b a8 g fis4 |
		e d cis b16 cis d e |
		...
		b4 a gis fis ~ |
		fis16 eis fis eis fis4 ~ fis16 a, b cis d e fis, eis |
		...
		b a g fis e d c b a fis g b c a b dis |
		e4 d cis b ~ |
...
alto = {
	...
	\relative c' {
		...
		fis8. g16 fis e dis cis b[ cis32 d cis8] ~ cis16 b a d |
		gis,4 a
		...
		fis a gis bis cis dis e fis e dis r a gis b a gis |
		fis2 gis2 ~ |
		...
		e16 e d cis d8 r r e'16 d cis d e8 ~ |
		e8 d16 cis b cis d8 ~ d cis16 b ais b cis8 ~|
		...
		r8 fis d b g' fis b ais |
		e dis r
		\stemDown <gis d>8 \stemUp << \new Voice { \shiftOn fis[ eis] fis8.[ e16] } \\ { cis2 } >> |
		<< dis1 \\ b1 >> | \bar "|."
	}
}
tenore = {
	...
	\relative c {
		...
		\staffDown a( gis) \staffUp f'( e) \staffDown b( ais)  \staffUp g'( fis) |
		...
		\clef "treble" \stemUp fis e d cis b cis d fis e cis d fis g e fis ais |
...
basso = {
	...
	\relative c {
		...
		g16 b, cis d e fis b, ais \tieDown b2 ~ |
		...
		d4 r8 dis e4 r8 eis |
		fis1 ~ |
		fis16 ais, b cis dis eis fis, eis fis2 |
		b1_\fermata | \bar "|."
	}
}
\header {
